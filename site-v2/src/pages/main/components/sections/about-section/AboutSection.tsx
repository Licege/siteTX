  ...
  return (
    <section className={c.AboutSection}>
      ...
      <article className={c.info}>
        <Typography className={c.title} variant="title1" align="center">Добро пожаловать</Typography>
        <div>
          ...
          <Button className={c.button} size="m" variant="outline">Подробнее о нас</Button>
        </div>
      </article>
    </section>
  );
